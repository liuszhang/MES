...
namespace DevExpress.DevAV.DevAVDbDataModel {
  ...
  /// <summary>
   ...
   if(isInDesignTime)
            ...
            //return new DbUnitOfWorkFactory<IDevAVDbUnitOfWork>(() => new DevAVDbUnitOfWork(() => new DevAVDb("~/DB/devav.sqlite3")));
            return new DbUnitOfWorkFactory<IDevAVDbUnitOfWork>(() => new DevAVDbUnitOfWork(() => new DevAVDb("devav.db")));
